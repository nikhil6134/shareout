...
import 'package:Shareout/screens/editProfile.dart';
import 'package:Shareout/widgets/post.dart';
import 'package:Shareout/widgets/header.dart';
import 'package:Shareout/widgets/post_tile.dart';
...
class _ProfileState extends State<Profile> {
      ...
      child: FlatButton(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: isFollowing ? Colors.white : Colors.deepOrangeAccent,
            border: Border.all(
                color: isFollowing ? Colors.grey : Colors.deepOrangeAccent),
  ...
  handleUnFollowUser() {
    ...
    //Make auth user follower of another user (update thier followers collection)
    followersRef
        .document(widget.profileId)
        .collection("userFollowers")
        .document(currentUserId)
    ...
    //add acitivity feed item for that user to notify about new follower(us)
    activityFeedRef
        .document(widget.profileId)
  ...
  handleFollowUser() {
    ...
    activityFeedRef
      ...
      "userProfileImg": currentUser.photUrl,
      "timestamp": timestamp,
    });
  }
