...
class _ActivityFeedState extends State<ActivityFeed> {
  getActivityFeed() async {
    ...
    List<AcitivityFeedItem> feedItems = [];
    snapshot.documents.forEach((doc) {
      feedItems.add(AcitivityFeedItem.fromDocument(doc));
    });
...
class AcitivityFeedItem extends StatelessWidget {
  ...
  factory AcitivityFeedItem.fromDocument(DocumentSnapshot doc) {
    return AcitivityFeedItem(
